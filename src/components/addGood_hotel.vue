<template>
    <a-form :form="addGoodform.form">
        ...
        <a-form-item :label="'客房类型'" :label-col="{ span: 4 }" :wrapper-col="{ span: 12 }">
            <a-select v-decorator="addGoodform.type" placeholder="客房类型">
        ...
        <a-form-item :label="'客房介绍'" :label-col="{ span: 4 }" :wrapper-col="{ span: 20}">
            ...
            handleSubmit() {
                this.addGoodform.form.validateFields((error, values) => {
                    if (error === null) {
                        ...
                        if(this.goodId ==''){
                            fetch.post('/product/room',parmas).then(res => {
                                console.log(res)
                            ...
                            console.log(parmas)
                                fetch.put( '/product/room/' + this.goodId, parmas).then(res => {
                                console.log(res)
                                message.info(res.msg);
                                    this.setEmptyForm();
                                this.$emit('hideModel')
